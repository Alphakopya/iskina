...
<body>
    <main>
        <div class="sidebar" id="sidebar">
            ...
            <a href="{{ route('profile') }}" class="ajax-link" data-url="{{ route('profile') }}""><span>Profile</a>
            <a href="{{ route('my.pay') }}" class="ajax-link" data-url="{{ route('my.pay') }}""><span>My Pay</a>
            ...
            <a href="{{ route('leaves') }}" class="ajax-link" data-url="{{ route('leaves') }}""><span>My Leaves</span></a>
