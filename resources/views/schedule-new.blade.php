        ...
        <div id="step2" class="step" style="display: none;">
            ...
            <form class="form-content" id="schedule-form">
                ...
                <div class="buttons">
                    ...
                    <button type="submit" id="submit-schedule" class="btn btn-primary">Create Schedule</button>
                </div>
            </form>
        </div>
    </div>
        ...
        $(document).ready(function () {
            ...
            function generateDayBoxes(startDate, endDate) {
                ...
                for (let i = 0; i < daysDiff; i++) {
                    ...
                    let className = 'work';
                    let status = 'Work';
                    scheduleDays.work.push(dateStr); // Default all to work
                    dayBoxes.append(`
